...
const VideoPlayerPageSkeleton: React.FC = () => {
  const SkeletonLine: React.FC<{ width: string; height?: string }> = ({ width, height = 'h-4' }) => (
    <div className={`bg-yt-light dark:bg-yt-dark-gray rounded ${width} ${height}`}></div>
  );
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 px-4 md:px-6 lg:px-8 animate-pulse">
      ...
      <div className="flex-grow lg:w-2/3">
        ...
        <div className="w-full aspect-video bg-yt-light-black dark:bg-yt-dark-gray rounded-xl mb-4"></div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
            <div className="flex items-center mb-3 md:mb-0">
                ...
                <div className="ml-6 h-9 w-24 rounded-full bg-yt-light dark:bg-yt-dark-gray"></div>
            </div>
             <div className="flex items-center space-x-2">
                <div className="h-9 w-32 rounded-full bg-yt-light dark:bg-yt-dark-gray"></div>
                <div className="h-9 w-24 rounded-full bg-yt-light dark:bg-yt-dark-gray"></div>
            </div>
        </div>

        {/* Description */}
        <div className="bg-yt-light dark:bg-yt-dark-gray p-3 rounded-xl mt-4 space-y-2">
